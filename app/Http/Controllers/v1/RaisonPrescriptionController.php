...
class RaisonPrescriptionController extends Controller
{
    ...
    public function index(Request $request){
       ...
       /*  if($request->search != ""){
            $options_financements = RaisonPrescription::like('valeur', $request->search)->get(['id', 'valeur', 'description']);
        }else{
            
        } */
        $options_financements = RaisonPrescription::orderBy('id', 'asc')->get(['id', 'libelle']);
    ...
    public function show($options_financement){
        ...
        $options_financement = RaisonPrescription::findOrFail($options_financement)->makeHidden(['created_at', 'updated_at', 'deleted_at']);
    ...
    public function store(Request $request){
        ...
        $options_financement = RaisonPrescription::create([
    ...
    public function update(Request $request, $options_financement){
        ...
        $this->validate($request, $this->validation());
        $options_financement = RaisonPrescription::findOrFail($options_financement);
